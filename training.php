          ...
          <form action="" method="POST" name="form1">
              <table width="25%" border="0">
                  <tr> 
                      ...
                      <td><input class="btn btn-primary mt-3" type="submit" name="Modelu" value="Model+Undersampling"></td>
                      <td><input class="btn btn-primary mt-3" type="submit" name="Modelo" value="Model+Oversampling"></td>
                  </tr>
              </table>
          </form>
          </div>
